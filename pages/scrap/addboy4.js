...
export default function AddBoys4({ navigation }) {
          ...
          <TouchableNativeFeedback onPress={() => photoref.current.open()}>
            <View style={styles.uploadphoto} >
              {photoimage != null && (
               ...
               <Image source={{uri:photoimage.path} } style={{ resizeMode:"cover",width:windowWidth-20, height:windowHeight/2}}></Image></View>
              )}
              {photoimage === null && (
                  <View style={{flex:1, alignItems:"center", justifyContent:'center', }}>
                <Image source={require("../asserts/user.png") } style={{ resizeMode:"cover",width:windowWidth-20, height:windowHeight/2}}></Image></View>
              )}
            </View>
          </TouchableNativeFeedback>
        </View>
