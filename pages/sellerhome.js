    ...
    <ScrollView>
      <SafeAreaView style={styles.page5container}>
        <View style={{ justifyContent: "center" }}>
          ...
          <Pressable
            onPress={() => {
              navigation.navigate("sellerneworders");
            }}
          >
            <View
              style={{
          ...
          <View>
            ...
            >
              ...
              <Pressable
                onPress={() => {
                  navigation.navigate("selleradditem");
                }}
              >
                {isEnabled && (
                  <Tile
              ...
              <Pressable
                onPress={() => {
                  navigation.navigate("selleritems");
                }}
              >
                {isEnabled && (
            ...
            >
              ...
              <Pressable
                onPress={() => {
                  navigation.navigate("selleronlineorders");
                }}
              >
                {isEnabled && (
                  <Tile
              ...
              <Pressable
                onPress={() => {
                  navigation.navigate("sellerofflinesales");
                }}
              >
                 {isEnabled && (
