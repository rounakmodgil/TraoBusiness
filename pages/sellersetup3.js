...
const formNavigatorData=[
  {
    label:'Store Details',
    navigate:'sellersetup',
    status:true
  },
  {
    label:'KYC',
    navigate:'sellersetup2',
    status:true
  },
  {
    label:'Address',
    navigate:'sellersetup3',
    status:true
  },
  {
    label:'Location',
...
export default function SellerSetup3({navigation}) {
    ...
    <SafeAreaView style={styles.page5container}>
      ...
      <FormNavigator navigation={navigation} data={formNavigatorData} width={parseInt(60)}/>
        ...
        <TextInput
          ...
          <Pressable onPress={() => {navigation.navigate("sellermap")}}>
