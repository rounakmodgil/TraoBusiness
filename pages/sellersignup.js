 ...
 */
 ...
 const SellerSignup = ({route, navigation}) => {
  const {Varsellersignup,Varfranchisetabscreen , Varsellertabscreen}=route.params;
   ...
   return (
     <View style={styles.container}>
      ...
      >
       ...
       <TouchableOpacity onPress={()=>{if(checked==="first"){Varsellersignup(false); Varfranchisetabscreen(true) } else{Varsellersignup(false); Varsellertabscreen(true)}}}>
