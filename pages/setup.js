      ...
      <FormNavigator navigation={navigation} data={formNavigatorData} width={parseInt(5)}/>
        ...
        <View >
          ...
          <View style={styles.inputContainer}>
            <Text style={{ color: "black", fontWeight:"300" }}>Reg Doc : </Text>
          ...
          <View style={styles.inputContainer}>
            <Text style={{ color: "black" , fontWeight:"300"}}>GST Doc : </Text>
          ...
          <View style={styles.inputContainer}>
            <Text style={{ color: "black", fontWeight:"300" }}>Pan Doc : </Text>
        ...
        <Pressable onPress={() => {navigation.navigate("setup2")}}>
